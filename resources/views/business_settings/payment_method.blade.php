            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Transportal Id')}}</label>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Transportal Password')}}</label>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Transportal Resourcekey')}}</label>
                        </div>
                        <div class="col-lg-6">
