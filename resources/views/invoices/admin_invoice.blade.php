		                ...
		                @if ($orderDetail->product != null)
							<tr class="">
								...
								<td class="text-center">
                                    @php
                                          <!--$seller_id = \App\Seller::where('id', $orderDetail->seller_id)->first();
                                          $sellers = \App\User::where('id', $seller_id->user_id)->first();-->
                                          $seller = DB::table('users')->find($orderDetail->seller_id);
