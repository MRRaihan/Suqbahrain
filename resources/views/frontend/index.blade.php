   ...
   @endif
    ...
    <section class="mb-3">
        <div class="container">
            ...
            <br>
              <div class="" style="background:white"><h1 style="color:red;text-decoration: underline;">Our Partner</h1>
<div class="" style="margin-left:10px; margin-bottom: 10px;margin-top:20px"><a href="https://www.ritsbrowser.com/" target="_blank"><img src="https://image.winudf.com/v2/image1/YWNyLmJyb3dzZXIucmFpc2Vicm93c2VyZnVsbF9pY29uXzE1NTQwODgyODhfMDc4/icon.png?w=170&fakeurl=1"></a>
