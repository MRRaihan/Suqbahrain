            ...
            <tbody>
                @foreach($customers as $key => $customer)
                    <tr>
                        ...
                        <td>{{ $customer->user->name ?? 'No data available' }}</td>
                        <td>{{ $customer->user->email ?? 'No data available' }}</td>
                        <td>{{ $customer->user->phone ?? 'No data available' }}</td>
                        <td>
                            
                                {{ $customer->user->customer_package->name ?? 'No data available' }}
                           
                        </td>
                        <td>{{ single_price($customer->user->balance ?? 'No data available') }}</td>
                        <td>
