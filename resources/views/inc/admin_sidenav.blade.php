                     ...
                     @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['bdo_report.index'])}}">
                                    <a class="nav-link" href="{{ route('bdo_report.index') }}">{{__('All Members Report')}}</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <!--Start Withdraw Request manu--> 
                        ...
                        @if(Auth::user()->user_type == 'admin')
                            <li>
                                ...
                                <!--Submenu-->
                                <ul class="collapse">
                                    <li class="{{ areActiveRoutes(['faqCategory.index', 'faqCategory.create', 'faqCategory.edit'])}}">
                                        <a class="nav-link" href="{{ route('faqCategory.index') }}"><i class="fa fa-folder"></i>{{__('Faq Categories')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['faq.index', 'faq.create', 'faq.edit'])}}">
                                        <a class="nav-link" href="{{route('faq.index')}}"><i class="fa fa-question-circle"></i>{{__('Faqs')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
