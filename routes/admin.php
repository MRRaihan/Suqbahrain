...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/all_bdo_report', 'AllMembersController@bdo_report')->name('bdo_report.index');
    Route::get('/all_distributor_report/{id}', 'AllMembersController@distributor_report')->name('distributor_report.index');
    Route::get('/all_merchant_report/{id}', 'AllMembersController@merchant_report')->name('merchant_report.index');
    Route::get('/all_customer_report/{id}', 'AllMembersController@customer_report')->name('customer_report.index');
    ...
    // Dashboard
    Route::resource('all-bdo','DashboardBDOController');
    Route::resource('all-distributor','DashboardDistributorController');
    Route::resource('all-merchant','DashboardMerchantController');
    Route::resource('all-customer','DashboardCustomerController');
