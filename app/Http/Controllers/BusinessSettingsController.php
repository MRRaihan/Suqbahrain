...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_method_update(Request $request)
    {
		...
		//echo $request->BENEFIT_TERMINAL_KEY;exit;
		if(isset($request->BENEFIT_TERMINAL_KEY)){
			$business_settings1 = BusinessSetting::where('type', 'BENEFIT_TERMINAL_KEY')->first();
			// dd($business_settings->type);
			if($business_settings1 != null){
				$business_settings1->value = $request->BENEFIT_TERMINAL_KEY;
