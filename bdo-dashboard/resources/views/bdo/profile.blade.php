...
@section('title', 'Update BDO Profile')
@section('content-head')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Update BDO Profile</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="offset-md-2 col-md-8">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">BDO Profile Update</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" disabled name="phone" class="form-control" id="phone" placeholder="Your phone" value="{{ \Illuminate\Support\Facades\Auth::user()->phone }}">
                                    </div>
                                    @error('phone')
                                    <label for="name" class="col-sm-4 col-form-label"></label>
                                    <div class="col-sm-8">
